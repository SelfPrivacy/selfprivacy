...
class _ExtendingVolumePageState extends State<ExtendingVolumePage> {
  ...
  Widget build(final BuildContext context) => FutureBuilder(
    ...
    builder:
        (final BuildContext context, final AsyncSnapshot<Price?> snapshot) {
          if (!snapshot.hasData) {
          ...
          _sizeController.text = _currentSliderGbValue == 0
              ? ''
              : currentSizeValue;
          _priceController.text =
              (_pricePerGb * _currentSliderGbValue.truncate()).toStringAsFixed(
                2,
              );
          minSize =
