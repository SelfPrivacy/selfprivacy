...
let
  ...
  pFilesystem =
    fetch alma "filesystem-3.8-6.el8.x86_64.rpm"
      "sha256-M+wZm374VldwQn5OrTRedbXY6W/74z8CNa4IjuRyY2E=";
  pGlibc =
  ...
  pBash =
    fetch alma "bash-4.4.20-6.el8_10.x86_64.rpm"
      "sha256-YJtRT9nLEyFQWGHdNOcOGWe4U5JE/uETDgqFov6fV2g=";
  pBusybox =
