  ...
  Widget build(final BuildContext context) => BrandHeroScreen(
    ...
    children: [
      ...
      ListTile(
        ...
        enabled: !InheritedAppController.of(context).shouldShowOnboarding,
        onTap: () => InheritedAppController.of(
          context,
              ...
              builder: (final BuildContext context) => DraggableScrollableSheet(
                ...
                builder: (final context, final scrollController) => ListView(
                  ...
                  children: [
                    ...
                    ListTile(
                      title: Text('developer_settings.server_type'.tr()),
                      subtitle: Text(
                    ...
                    ListTile(
                      title: Text('developer_settings.server_volume_name'.tr()),
                      subtitle: Text(server.hostingDetails.volume.name),
                    ),
                    ListTile(
                      title: Text('developer_settings.server_volume_size'.tr()),
                      subtitle: Text(
                        server.hostingDetails.volume.sizeByte.toString(),
                      ),
                    ),
                    ListTile(
                      title: Text(
                        'developer_settings.server_volume_location'.tr(),
                      ),
                      subtitle: Text(
                    ...
                    ListTile(
                      title: Text('developer_settings.server_domain'.tr()),
                      subtitle: Text(server.domain.domainName),
                    ),
                    ListTile(
                      title: Text('server.dns_provider'.tr()),
                      subtitle: Text(server.domain.provider.displayName),
                    ),
                  ],
                ),
              ),
